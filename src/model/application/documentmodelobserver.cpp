...
export module model.documentmodelobserver;
...
public:
	explicit DocumentModelObserver(Application& app)
		: m_document(nullptr)
	{
		QObject::connect(&app, &Application::documentRestoredFromHistory, this,
						 &DocumentModelObserver::internalDocumentRestoredFromHistory);
		QObject::connect(&app, &Application::newDocumentOpened, this,
						 &DocumentModelObserver::internalNewDocumentOpened);
	}
};
