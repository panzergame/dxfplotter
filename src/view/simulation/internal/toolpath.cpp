...
void ToolPath::createPolylineFromPoints(const model::Simulation::ToolPathPoint3D::List& points)
{
	...
	Qt3DCore::QAttribute* vertexAttribute = new Qt3DCore::QAttribute(
		vertexBuffer, Qt3DCore::QAttribute::defaultPositionAttributeName(), Qt3DCore::QAttribute::Float, 3, nbPoints);
