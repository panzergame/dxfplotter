...
private:
	...
	Bezier::InflexionPoints inflexions() const
	{
...
public:
	explicit Bezier(const QVector2D& p1, const QVector2D& c1, const QVector2D& c2, const QVector2D& p2)
		: m_point1(p1)
		, m_point2(p2)
		, m_control1(c1)
		, m_control2(c2)
	...
	const QVector2D& point1() const { return m_point1; }

	const QVector2D& point2() const { return m_point2; }

	const QVector2D& control1() const { return m_control1; }

	const QVector2D& control2() const { return m_control2; }
	...
	Bezier::Pair split(float t) const
	{
		assert(0.0f < t && t < 1.0f);
	...
	Bezier::List splitToConvex() const
	{
	...
	Polyline toLine() const { return Polyline({ Bulge { m_point1, m_point2, 0.0f } }); }
