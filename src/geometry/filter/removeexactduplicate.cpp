...
private:
	...
	RemoveExactDuplicate::UndirectedPolyline::List buildPolylinesMap(const Polyline::List& polylines) const
	{
	...
	buildPolylineMaskWithoutDuplicate(const UndirectedPolyline::List polylinesMap, int nbPolylines) const
	{
