...
export module exporter.gcode.exporter;
...
{
public:
	enum Options { None = 0, ExportConfig = (1 << 0), ExportMetadata = (1 << 1) };
...
public:
	explicit Exporter(const config::Tools::Tool& tool, const config::Profiles::Profile& profile,
