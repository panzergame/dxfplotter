...
public:
	...
	bool has(const std::string& name) const { return m_children.find(name) != m_children.end(); }
	...
	Child& operator[](const std::string& name) { return m_children.find(name)->second; }

	const Child& operator[](const std::string& name) const { return m_children.find(name)->second; }

	Child& first() { return m_children.begin()->second; }

	const Child& first() const { return m_children.begin()->second; }
