...
var wasmBinaryFile;
  wasmBinaryFile = 'dxfplotter.wasm';
...
var ASM_CONSTS = {
  4251598: ($0) => { let directory = UTF8ToString($0); console.log("Setup config directory to: " + directory); FS.mount(IDBFS, {}, directory); FS.syncfs(true, function (err) { }); }
};
...
var ___start_em_js = Module['___start_em_js'] = 4251116;
var ___stop_em_js = Module['___stop_em_js'] = 4251598;
